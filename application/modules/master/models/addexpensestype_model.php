<?php 
class addexpensestype_model extends CI_Model {
	public $table_name = 'tbl_expensetype';
    ...
    public function get_all_records() {
    		$this->db->select('tbl_subaccountgroup.id as subid, tbl_subaccountgroup.account_name as subName, tbl_expensetype.*');
			$this->db->from('tbl_expensetype');
			$this->db->join('tbl_subaccountgroup','tbl_subaccountgroup.id = tbl_expensetype.account_id');
    ...
    public function get_single_record($id='') {
		...
		$this->db->join('tbl_subaccountgroup','tbl_subaccountgroup.id = tbl_expensetype.account_id');
		if($id != ''){
			$this->db->where("tbl_expensetype.id",$id);
			$query = $this->db->get();
			//echo $this->db->last_query();
	...
	public function add_record(){
		$set_data = array(
		                 ...
		                 'expensestype_name' => $this->input->post('expensetype'),
					);
