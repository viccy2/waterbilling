<?php 
class addsubaccountgroup_model extends CI_Model {
	public $table_sub = 'tbl_accountgroup';
	public $table_name = 'tbl_subaccountgroup';
    ...
    public function get_all_records() {
        $this->db->select("tbl_accountgroup.id as acc_id, tbl_accountgroup.group_name as aname,tbl_subaccountgroup.* ");
		$this->db->from('tbl_subaccountgroup');
		$this->db->join('tbl_accountgroup','tbl_subaccountgroup.account_id = tbl_accountgroup.id');
		$this->db->order_by('tbl_subaccountgroup.id','desc');
		$query = $this->db->get();
		//echo $this->db->last_query();
		$result = $query->result_array();
		return $result;
	...
	public function add_record(){
		$set_data = array(
						 ...
						 'account_name' => $this->input->post('subaccountname'),
					);
