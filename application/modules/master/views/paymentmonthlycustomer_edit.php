				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo ADMIN_URL;?>paymentmonthlycustomer">Monthly Customer Bills</a>
							</li>
                            ...
                            <?php } ?>	
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="plan_name" name="plan_name" class="col-xs-10 col-sm-10" value="<?php echo $record['plan_name']; ?>" required/>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="balance" name="balance" class="col-xs-10 col-sm-10" value="<?php echo $record['balance']; ?>" required/>
