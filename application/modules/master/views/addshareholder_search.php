		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>addcustomer/">Share Holder</a></li>
					<li><a href="<?php echo ADMIN_URL?>addshareholder/add/">Add Share Holder</a></li>
					<li>Search</li>
				</ol>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="glyphicon glyphicon-search"></i>&nbsp; search <span>> Share Holder  </span></h1>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<div class="form-horizontal" >
											...
											<fieldset>
												<legend>Share Holder-Search <div class="pull-right" style="padding-right:20px;"><input type="submit" class="btn btn-primary" name="search" id="search" value="search" onclick="getaddcustomer();"></div> </legend>
