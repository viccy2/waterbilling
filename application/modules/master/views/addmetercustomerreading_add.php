													...
													<input type="submit" class="form-control"  id="search_box_id" name="name" id="name" value = "Search" style="width: auto; float: right; margin-right: 502px; background: #3276b1; color:#fff;" />                                                                                                
														...
														<div id="hideclass" style="display:none; padding:20px; box-shadow: 0px 0px 3px 1px rgba(0,0,0,0.75);    margin: 14px;" >
															<div class="form-group" style=" width: 60%;">
																<label class="col-md-4 control-label">  Preview Meter : </label>
																<div class="col-md-4">
																	<input  type="text" class="form-control"  id="preview" name="preview" value="<?php echo $this->input->post('preview'); ?>" readonly ="readonly"/>
															...
															<div class="form-group" style=" width: 60%;">
																<label class="col-md-4 control-label">Current meter : </label>
																<div class="col-md-4">
																	<input type="text"  class="form-control"  id="current_meter" name="current_meter"  value="<?php echo $this->input->post('current_meter'); ?>" />
																</div>
															</div>
															<div class="form-group"style=" width: 60%;">
																<label class="col-md-4 control-label"> Different : </label>
																<div class="col-md-4">
															...
															<div class="form-group" style=" width: 60%;">
																...
																<div class="col-md-4">
																	<input type="text"  class="form-control"  id="unit_price" name="unit_price"  value="<?php echo $this->input->post('unit_price'); ?>" readonly ="readonly"/>
															...
															<div class="form-group" style=" width: 60%;">
																...
																<div class="col-md-4">
																	<input  type="text"  class="form-control"  id="amount_pay" name="amount_pay" value="<?php echo $this->input->post('amount_pay'); ?>" readonly ="readonly"/>
...
$('#search_box_id').on('change', function() {
	...
	$.ajax({
                type: 'POST',
                url: '<?php echo ADMIN_URL;?>addmetercustomerreading/get_custmer_all_data/',
                data: {id: id},
...
$('#current_meter').on('change', function() {
