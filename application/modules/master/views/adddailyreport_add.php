						...
						<div class="col-sm-6 col-lg-12">
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
											...
											<fieldset>
														<legend>Daily Report Bills -Search <input type="submit" class="btn btn-primary" name="search" id="search" value="search" onclick="getaddcustomer_paid();" style="margin-bottom: 5px; float: right; margin-right:20px;"></legend>
													<div class="form-group col-lg-6">
                                                        ...
                                                        <div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong> Type:</strong></span>
																	<input class="form-control"  type="text" id="type" name="type"  value="All/monthly/Meters/salary/rent/et" readonly>
																</div>
															</div>
														</div>
