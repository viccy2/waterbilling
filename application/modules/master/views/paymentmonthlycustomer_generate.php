			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>add <span>>  Monthly Customer Generate Bills  </span></h1>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Monthly Customer Generate Bills-Add </legend>
													<div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group">
															<span class="input-group-addon"><i class="icon-user"></i><strong> Gender: </strong></span>
																<select name="years" id="years" class="form-control" required onchange="getcustomermonth(this.value)">
													...
													<div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group" id="showcustomers" <?php if($record['customer_type']=='metercustomer'){ ?> style="display:none;" <?php } ?>>
															<span class="input-group-addon"><i class="icon-user"></i><strong>	
															Billing Plans: </strong></span>
...
//alert(id);
	...
	$.ajax({
		type : "POST",
		url	: '<?php echo ADMIN_URL;?>paymentmonthlycustomer/get_years',
		data	: "id="+id,
...
function getcustomermonth1(id){
//alert(id);
	
	$.ajax({
		type : "POST",
		url	: '<?php echo ADMIN_URL;?>paymentmonthlycustomer/get_balance',
		data	: "id="+id,
		complete: function(data){
			var op = data.responseText.trim(); 
			//alert(op);
...
function getcustomername(id){
		$.ajax({
		type : "POST",
		url	: '<?php echo ADMIN_URL;?>paymentmonthlycustomer/get_name',
		data	: "id="+id,
		complete: function(data){
			var op = data.responseText.trim();
			//alert(op);
...
function getcustomermonth(year){
	
	var year_split = year.split('**');
	//alert(year_split);
	$.ajax({
		type : "POST",
		url	: '<?php echo ADMIN_URL;?>paymentmonthlycustomer/get_months_generate',
		data	: "id="+year_split[1]+"&year="+year_split[0],
		complete: function(data){
			var op = data.responseText.trim(); 
			//alert(op);
			$("#month").html(op);
...
function getcustomerbalanceamount(id){
	
	var id_split = id.split('**');
	
	$.ajax({
	   type : "POST",   
	   url	: '<?php echo ADMIN_URL;?>paymentmonthlycustomer/getbalance',      
	   data	: "id="+id_split[1]+"&month="+id_split[0],
	   complete: function(data){  
		  var op = data.responseText.trim();
        //alert(op);
		 $("#plan_name").html(op);  
