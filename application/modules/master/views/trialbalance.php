						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header style="height: 42px;">
									...
									<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Trial Balance</strong>
									</p>
								</header>
												...
												//		if(count($record) > 0){
													...
													<td><?php echo $i;//." / ".$row['id'];?></td>
														...
														<?php 
															...
															echo $result['group_name'];?><br>&nbsp;<i class="fa fa-level-up fa-rotate-90" aria-hidden="true"></i> <span style="margin-left:10px"><?php 
															...
															<br> <i style="margin-left:26px" class="fa fa-level-up fa-rotate-90" aria-hidden="true"></i><span style="margin-left:10px"><?php 
												...
												//		if(count($record) > 0){
													...
													<td><?php echo $i;//." / ".$row['id'];?></td>
														...
														<?php	foreach($subgroup as $row2) { 
																...
																$subgrp = $subName[0]; 
																if($grp==$subgrp){ 
															?><br>&nbsp;<i class="fa fa-level-up fa-rotate-90" aria-hidden="true"></i> 
															...
															<?php foreach($ledger as $row3)  {  
																...
																?>
															<br> <i style="margin-left:26px" class="fa fa-level-up fa-rotate-90" aria-hidden="true"></i>
