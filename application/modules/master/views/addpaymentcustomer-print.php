			  ...
			  <div class="maindiv22">
				<div class="main-border" style="border:#000000 solid 1px;">
				   <!--<div class="headerleft" style="float:left; margin-right:20px">
					...
					<div style="color:#438eb9; width:157px; margin:0px auto; font-size:25px; font-weight:bold; border:#438eb9 solid 2px; -moz-border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px; padding:10px; margin-bottom:5px;">Meter Customers Invoice</div>
					<div style="font-weight:bold;">Date : <?php if(array_key_exists("create_date_time",$record)){ echo date('d-m-Y',strtotime($record['create_date_time']));}?>
					<br />
...
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Meter Details</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Per Unit</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Amount</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Balance</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Total</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Status</th>
...
<td height="30" align="center" valign="middle" bgcolor="#FFFFFF">
			<b>Per Unit :</b> <?php echo stripslashes($record['perunit']); ?><br/>		
</td>
<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" class="hidden-480">
