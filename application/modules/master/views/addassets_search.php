			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="glyphicon glyphicon-search"></i>&nbsp; search <span>> Assets  </span></h1>
					</div>
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
						...
						<div class="col-xs-12" id="assetsDiv" style="margin-top: 13px;"></div>	
				        </div>
