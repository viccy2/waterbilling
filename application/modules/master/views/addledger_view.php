		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>addledger/add/">addeledger</a></li>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Ledger-View </span></h1>
					</div>
							...
							<div>
								...
								<div class="space-4"></div>
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="<?php echo ADMIN_URL;?>addedger/edit/<?php echo $record['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?php echo ADMIN_URL;?>addedger" class="btn btn-sm btn-danger">Cancel</a>
										</div>
									</div>
						</div><!-- /.row -->
