			  ...
			  <div class="maindiv22">
				<div class="main-border" style="border:#000000 solid 1px;">
				   <!--<div class="headerleft" style="float:left; margin-right:20px">
					...
					<div style="color:#438eb9; width:157px; margin:0px auto; font-size:25px; font-weight:bold; border:#438eb9 solid 2px; -moz-border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px; padding:10px; margin-bottom:5px;">Customer Invoice</div>
					<div style="font-weight:bold;">Date : <?php if(array_key_exists("create_date",$record)){ echo date('d-m-Y',strtotime($record['create_date']));}?>
					<br />
					Customer-Id : <?php if($record['customer_id'] != ''){ echo stripslashes($record['customer_id']); }else{echo stripslashes($record['customer_id']); } ?>
					</div></div>
...
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Customer-Id</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Customer Details</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Contact Details</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Customer Type</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Reference Name</th>
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Created Date</th>
</tr>
</thead>
<tbody>                                                      
<tr>
...
<td height="30" align="center" valign="middle" bgcolor="#FFFFFF"><?php echo stripslashes($record['referenceperson']); ?></td>
