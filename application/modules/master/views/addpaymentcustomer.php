			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> View <span>> Meter Customer Bills  </span></h1>
					</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header style="height: 42px;">
									...
									<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Meter Customer Bills</strong>
									</p>
								</header>
										   ...
										   <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												...
												<thead>			                
													<tr>
														...
														<th data-hide="expand">Intaa waxaa dheer</th>
														<th data-hide="expand">Per-Unit</th>
														<th data-hide="expand">Amount</th>
														<th data-hide="expand">Balance</th>
														<th data-hide="expand">Pay Amount</th>
														<th data-hide="expand">Remain Amount</th>
                                                ...
                                                ?>   
													<tr>
														...
														<td><?php echo stripslashes($row['per_unit']); ?></td>
