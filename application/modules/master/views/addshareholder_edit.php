			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>&nbsp; Edit <span>> Share </span></h1>
					</div>
													...
													<div class="form-actions">
														<div class="row">
															<div class="col-md-12">
																 ...
																 <a href="<?php echo ADMIN_URL;?>addshareholder" class="btn btn-default">Cancel</a>
