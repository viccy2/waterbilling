			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>edit <span>>  Assets </span></h1>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Assets-Edit </legend>
												<div class="form-group col-lg-6">
													<div class="col-lg-12 controls">
														<div class="form-group">
																<span class="input-group-addon"><i class="icon-user"></i><strong>Asset Type : </strong></span>
