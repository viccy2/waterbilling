		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>addemployee/add/">add employee</a></li>
					<li>add</li>
				</ol>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="glyphicon glyphicon-search"></i>&nbsp; search <span>> Employee-Search  </span></h1>
					</div>
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
						...
						<div class="col-xs-12" id="employeeDiv"></div>	
			            </div>
