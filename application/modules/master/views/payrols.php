		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>payrols/add/">Add Payrols </a></li>
					<li>List View</li>
				</ol>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> View <span>> payrols </span></h1>
					</div>
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Payrols</strong>
								</p>
								</header>
								...
								<div>
				                    ...
				                    <form method="post" action="<?php echo ADMIN_URL;?>payrols/multi_delete">
										<!-- widget content -->
