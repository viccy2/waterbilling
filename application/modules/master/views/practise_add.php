                            ...
                            <?php } ?>	
								<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo ADMIN_URL;?>practise/add/" enctype="multipart/form-data">
								    ...
								    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" name="title" class="col-xs-10 col-sm-5" value="<?php echo $this->input->post('title'); ?>" required/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="status" id="status" type="radio" class="ace" value="1" <?php /*if($this->input->post('status')=='1'){?> checked="checked" <?php }else{ echo 'checked="checked"'; }*/?>  checked="checked"/>
                                                <span class="lbl"> Active</span>
                                                <input name="status" id="status" type="radio" class="ace" value="0" <?php /*if($this->input->post('status')=='0'){?> checked="checked" <?php }else{ echo ''; }*/?> />
