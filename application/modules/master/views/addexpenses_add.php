			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>add <span>>  Expenses </span></h1>
					</div>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Expenses-Add </legend>
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">  
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Ledger : </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Expenses-Id : </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong> Expenses :</strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>  Quantity: </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong> Date : </strong></span>
																	...
																	<!--<input type="text" name="date" id="date"  class="col-xs-10 col-sm-10" placeholder="DD-MM-YYYY" value="<?php echo ($this->input->post('date') != '')?date('d-m-Y',strtotime($this->input->post('date'))):date('d-m-Y');?>" readonly="readonly"  required/>-->
