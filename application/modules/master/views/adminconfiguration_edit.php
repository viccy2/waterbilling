			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>Configuration <span>>  Edit </span></h1>
					</div>
					<?php /*
											...
											<fieldset>
                                                        ...
                                                        <div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																...
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong>Name : </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong>Email :</strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong> Established on : </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong> Contact :  </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong> Contact Person:  </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong> Contact Person Phone:  </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong> Web Site:  </strong></span>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-chevron-down"></i><strong>  About :  </strong></span>
													...
													<div class="form-actions">
														<div class="row">
															<div class="col-md-12">
																 ...
																 <a href="<?php echo ADMIN_URL;?>addcustomer/adminconfiguration" class="btn btn-default">Cancel</a>
