			  ...
			  <div class="maindiv22">
				<div class="main-border" style="border:#000000 solid 1px;">
				   <!--<div class="headerleft" style="float:left; margin-right:20px">
					...
					<div style="color:#438eb9; width:157px; margin:0px auto; font-size:25px; font-weight:bold; border:#438eb9 solid 2px; -moz-border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px; padding:10px; margin-bottom:5px;">Monthly Customers Invoice</div>
...
<th height="30" align="center" valign="middle" bgcolor="#f2f2f2" class="hidden-480">Plan Details</th>
