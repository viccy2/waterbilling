														...
														<div id="hideclass" style="display:none; padding:20px; box-shadow: 0px 0px 3px 1px rgba(0,0,0,0.75);    margin: 14px;" >
															...
															<div class="form-group">
																...
																<div class="col-md-4">
																	...
																	<input type="text"  class="form-control"  id="paid_total_amount" name="paid_total_amount"  value="<?php echo $this->input->post('paid_total_amount'); ?>" readonly ="readonly"/>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-md-4">
																	<input type="text"  class="form-control"  id="oldmeter" name="consumedunits"  value="<?php echo $this->input->post('consumedunits'); ?>" readonly ="readonly"/>
																	<?php echo form_error('consumedunits'); ?>
																</div>
															</div>
