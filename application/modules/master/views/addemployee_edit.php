														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	...
																	<input class="form-control" type="text" id="base_salary" name="base_salary"  value="<?php echo $record['base_salary']; ?>" required/>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	...
																	<input class="form-control" type="text" id="tax" name="tax" value="<?php echo $record['tax']; ?>" required/>
