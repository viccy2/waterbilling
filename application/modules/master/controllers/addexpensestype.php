...
class addexpensestype extends CI_Controller {
	// Declare globle variable here
	
	public $headerPage = '../../views/admin-includes/header'; 
	
	public $addPage  = 'addexpensestype_add';	     //*****  Add page    *****//
	public $editPage = 'addexpensestype_edit';     //*****  Edit page   *****//
	public $listPage = 'addexpensestype';		   //*****  View page   *****//
	public $viewPage ='addexpenses_view';
	
	public $listPage_redirect = '/master/addexpensestype';		  //*****  Redirect View  *****//
	public $addPage_redirect = '/master/addexpensestype/add/';	 //*****  Redirect Add   *****//
	public $editPage_redirect = '/master/addexpensestype/edit/';  //*****  Redirect Edit  *****//
	public function __construct() {
        parent::__construct();
  		$this->load->model('addexpensestype_model','my_model');   //*****    Model Loading     *****//	
