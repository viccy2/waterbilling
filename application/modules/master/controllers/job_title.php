...
class job_title extends CI_Controller {
	...
	public $table_name = 'tbl_jobtitle';	  //*****  Table name  *****//
	public $addPage  = 'job_title_add';	     //*****  Add page    *****//
	public $editPage = 'job_title_edit';     //*****  Edit page   *****//
	public $listPage = 'job_title';		   //*****  View page   *****//
	
	public $listPage_redirect = '/master/job_title';		  //*****  Redirect View  *****//
	public $addPage_redirect = '/master/job_title/add/';	 //*****  Redirect Add   *****//
	public $editPage_redirect = '/master/job_title/edit/';  //*****  Redirect Edit  *****//
	public function __construct() {
        parent::__construct();
  		$this->load->model('job_title_model','my_model');   //*****    Model Loading     *****//	
